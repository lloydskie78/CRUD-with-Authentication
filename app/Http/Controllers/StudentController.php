...
class StudentController extends Controller
{
    public function index(){
        ...
        $students = Student::paginate(5); // it means you will get all the data from student table in database
                                            //paginate method is for limiting the diplay value in the table
